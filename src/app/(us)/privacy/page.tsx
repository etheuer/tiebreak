...
export default function PrivacyPage() {
  ...
  return (
    <LegalPage title="Privacy policy">
      ...
      <h2 className="mt-2 text-lead font-semibold tracking-[-0.02em] text-ink">What we collect</h2>
      <p>
      ...
      <h2 className="mt-2 text-lead font-semibold tracking-[-0.02em] text-ink">Cookies and storage</h2>
      <p>
      ...
      <h2 className="mt-2 text-lead font-semibold tracking-[-0.02em] text-ink">Analytics</h2>
      <p>
      ...
      <h2 className="mt-2 text-lead font-semibold tracking-[-0.02em] text-ink">We do not sell data</h2>
      <p>
        We do not sell personal information. We do not run ads on these pages. There are no
        affiliate checkout links on this launch.
      </p>
      <h2 className="mt-2 text-lead font-semibold tracking-[-0.02em] text-ink">Contact</h2>
      <p>
        Privacy questions:{' '}
        {email ? (
