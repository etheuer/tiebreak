...
export async function CompareBuildPage({ market }: { market: MarketId }) {
  ...
  return (
    <div className="shell">
      ...
      <header className="cb-section">
        <p className="eyebrow">Custom comparison</p>
        <h1 className="display mt-2 text-h1">Bring your shortlist together.</h1>
        <p className="mt-3 text-body leading-relaxed text-ink-2">
          Pick two products of the same type. Published pairs open their full
          breakdown; every other pair is scored instantly from the same
          published specs.
        </p>
        <CompareBuilder
