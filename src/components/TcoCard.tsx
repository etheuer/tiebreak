...
export function TcoCard({
  ...
  if (
    !hasExtraCosts &&
    productA.subcategory !== "air-purifiers" &&
    productA.subcategory !== "cordless-vacuums"
  ) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      {hasReversal && reversalSummary && (
        <div className="mt-3 rounded-xl border border-rival/25 bg-rival-tint px-3.5 py-2.5 text-cell leading-snug text-rival-2">
          <span className="font-semibold">The longer-term difference: </span>
          {reversalSummary}
        </div>
      )}
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2 sm:gap-4">
        {/* Product A */}
        <div className="col-a rounded-xl border border-line p-3.5">
          <p
        ...
        {/* Product B */}
        <div className="col-b rounded-xl border border-line p-3.5">
          <p
            className="text-label font-semibold "
